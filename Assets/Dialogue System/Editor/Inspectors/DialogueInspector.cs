...
namespace DialogueSystem.Editor.Inspectors
{
    ...
    public class DialogueInspector : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            var currentDialogueContainer = (DialogueSystemDialogueContainer)dialogueContainerProperty.objectReferenceValue;
            ...
            DrawFiltersArea();
            var currentGroupedDialoguesFilter = groupedDialoguesProperty.boolValue;
            var currentStartingDialoguesOnlyFilter = startingDialoguesOnlyProperty.boolValue;
            List<string> dialogueNames;
            var dialogueFolderPath = $"Assets/Dialogue System/Dialogues/{currentDialogueContainer.FileName}";
        ...
        private void DrawFiltersArea()
        {
            ...
            _ = groupedDialoguesProperty.DrawPropertyField();
            _ = startingDialoguesOnlyProperty.DrawPropertyField();
            DialogueSystemEditorUtility.DrawSpace();
        }

        private void DrawDialogueGroupArea(DialogueSystemDialogueContainer dialogueContainer, List<string> dialogueGroupNames)
        {
            ...
            selectedDialogueGroupIndexProperty.intValue = DialogueSystemEditorUtility.DrawPopup("Dialogue Group", selectedDialogueGroupIndexProperty, dialogueGroupNames.ToArray());
            var selectedDialogueGroupName = dialogueGroupNames[selectedDialogueGroupIndexProperty.intValue];
            var selectedDialogueGroup = DialogueSystemIOUtility.LoadAsset<DialogueSystemDialogueGroup>($"Assets/Dialogue System/Dialogues/{dialogueContainer.FileName}/Groups/{selectedDialogueGroupName}", selectedDialogueGroupName);
        ...
        private void DrawDialogueArea(List<string> dialogueNames, string dialogueFolderPath)
        {
            ...
            var selectedDialogue = DialogueSystemIOUtility.LoadAsset<DialogueSystemDialogue>(dialogueFolderPath, selectedDialogueName);
        ...
        private void StopDrawing(string reason, MessageType messageType = MessageType.Info)
        {
            ...
            DialogueSystemEditorUtility.DrawSpace();
            DialogueSystemEditorUtility.DrawHelpBox("You need to select a Dialogue for this component to work properly at Runtime!", MessageType.Warning);
            _ = serializedObject.ApplyModifiedProperties();
        }
        ...
        private void UpdateIndexOnNamesListUpdate(List<string> optionNames, SerializedProperty indexProperty, int oldSelectedPropertyIndex, string oldPropertyName, bool isOldPropertyNull)
        {
            ...
            var oldNameIsDifferentThanSelectedName = oldIndexIsOutOfBoundsOfNamesListCount || oldPropertyName != optionNames[oldSelectedPropertyIndex];
