...
namespace DialogueSystem.Editor.Windows
{
    public class DialogueSystemEditorWindow : EditorWindow
    {
        ...
        {
            _ = rootVisualElement.AddStyleSheets("Dialogue System/DialogueSystemVariables.uss");
        }
        ...
        private void Load()
        {
            var filePath = EditorUtility.OpenFilePanel("Dialogue Graphs", "Assets/Dialogue System/Editor/Graphs", "asset");
