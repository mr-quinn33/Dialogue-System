...
namespace DialogueSystem.Editor.Inspectors
{
    ...
    public class DialogueInspector : UnityEditor.Editor
    {
        ...
        private void DrawDialogueGroupArea(DialogueSystemDialogueContainer dialogueContainer, List<string> dialogueGroupNames)
        {
            ...
            var selectedDialogueGroup = DialogueSystemIOUtility.LoadAsset<DialogueSystemDialogueGroup>($"Assets/DialogueSystem/Dialogues/{dialogueContainer.FileName}/Groups/{selectedDialogueGroupName}", selectedDialogueGroupName);
        ...
        private static void UpdateIndexOnNamesListUpdate(List<string> optionNames, SerializedProperty indexProperty, int oldSelectedPropertyIndex, string oldPropertyName, bool isOldPropertyNull)
        {
